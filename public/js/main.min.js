...
var defaultLanguage = localStorage.getItem("insight-language") || "en",
    defauN7urrency = localStorage.getItem("insight-currency") || "N7";
    ...
    .controller("CurrencyController", function($scope, $rootScope, Currency) {
        ...
        $rootScope.currency.getConvertion = function(value) {
            if (value = 1 * value, !isNaN(value) && "undefined" != typeof value && null !== value) {
                ...
                var response;
                return "BTC" === this.symbol ? response = _roundFloat(value * this.factor, 8) : "mN7" === this.symbol ? (this.factor = 1e3, response = _roundFloat(value * this.factor, 5)) : "uN7" === this.symbol ? (this.factor = 1e6, response = _roundFloat(value * this.factor, 2)) : (this.factor = 1, response = value), 1e-7 > response && (response = response.toFixed(8)), response + " " + this.symbol
            }
            return "value error"
        }, $scope.setCurrency = function(currency) {
            $rootScope.currency.symbol = currency, localStorage.setItem("insight-currency", currency), "BTC" === currency ? Currency.get({}, function(res) {
                $rootScope.currency.factor = $rootScope.currency.yobitBTC = res.data.yobitBTC
            }) : $rootScope.currency.factor = "mN7" === currency ? 1e3 : "uN7" === currency ? 1e6 : 1
...
angular.module("insight")
    ...
    .run(["gettextCatalog", function(gettextCatalog) {
        gettextCatalog.setStrings("ru", {
            "(Input unconfirmed)": "(Неподтвержденная запись)",
            "404 Page not found :(": "404 Страница не найдена :(",
            '<strong>insight</strong>  is an <a href="http://live.insight.is/" target="_blank">open-source number7 blockchain explorer</a> with complete REST and websocket APIs that can be used for writing web wallets and other apps  that need more advanced blockchain queries than provided by number7 RPC.  Check out the <a href="http://github.com/bitpay/insight" target="_blank">source code</a>.': '<strong>insight</strong>  это <a href="http://live.insight.is/" target="_blank">number7 блок-браузер с открытым исходным кодом</a> с полным набором API-интерфейсов REST и WebSockets, которые могут быть использованы для записи number7 кошельков и других приложений, требующих проверки блоков браузера. Получить код можно <a href="http://github.com/bitpay/insight" target="_blank">в открытом хранилище Github</a>.',
            '<strong>insight</strong> is still in development, so be sure to report any bugs and provide feedback for improvement at our <a href="https://github.com/bitpay/insight/issues" target="_blank">github issue tracker</a>.': '<strong>insight</strong> мы все еще в стадии разработки, поэтому мы ценим ваши отчеты об ошибках и предложения по улучшению программного обеспечения. <a href="https://github.com/bitpay/insight/issues" target="_blank">Github issue tracker</a>.',
            About: "О нас",
            Address: "Адрес",
            Age: "Возраст",
            "Application Status": "Состояние приложения",
            "Best Block": "лучший блок",
            "number7 node information": "Информация о number7 узле",
            Block: "Блок",
            "Block Reward": "Вознаграждение за блок",
            Blocks: "Блоки",
            "Bytes Serialized": "Байты сериализованны",
            "Can't connect to number7d to get live updates from the p2p network. (Tried connecting to number7d at {{host}}:{{port}} and failed.)": "Не удалось подключиться к number7d для получения новых обновлений от сети p2p. (Была сделана попытка подключиться к number7d {{host}}:{{port}} и она провалилась.)",
            "Can't connect to insight server. Attempting to reconnect...": "Не удалось подключиться к серверу. Восстанавливается соединение...",
            "Can't connect to internet. Please, check your connection.": "Не удалось подключиться к Интернету. Пожалуйста, проверьте соединение.",
            Complete: "Готово",
            Confirmations: "Подтверждения",
            Conn: "С",
            "Connections to other nodes": "Соединения с другими узлами",
            "Current Blockchain Tip (insight)": "Текущая комиссия системы",
            "Current Sync Status": "Текущий статус синхронизации",
            Details: "Детали",
            Difficulty: "Сложность",
            "Double spent attempt detected. From tx:": "Попытка двойного расходования обнаружена. Из транзакции:",
            "Error!": "Ошибка!",
            Fee: "Ставка",
            "Final Balance": "Окончательный баланс",
            "Finish Date": "Окончательная дата",
            "Go to home": "Вернуться на главную",
            "Hash Serialized": "Хэш сериализован",
            Height: "Высота",
            "Included in Block": "Включено в блок",
            "Incoherence in levelDB detected:": "Обнаружено несоответствие в levelDB:",
            "Info Errors": "Информация об ошибках",
            "Initial Block Chain Height": "Высота исходной цепи блока",
            Input: "Запись",
            "Last Block": "Последний блок",
            "Last Block Hash (number7d)": "Хэш последнего блока (number7d)",
            "Latest Blocks": "Последние блоки",
            "Latest Transactions": "Последние транзакции",
            "Loading Address Information": "Загрузка информации об адресе",
            "Loading Block Information": "Загрузка информации о блоке",
            "Loading Selected Date...": "Загрузка выбранной даты...",
            "Loading Transaction Details": "Загрузка информации о транзакции",
            ...
            "No Inputs (Newly Generated Coins)": "Нет поступлений (созданных новых монет)",
            "No blocks yet.": "Блоков пока нет",
            "No matching records found!": "Соответствующих записей не найдено!",
            "No. Transactions": "Номер транзакции",
            ...
            "See all blocks": "Просмотреть все блоки",
            "Show Transaction Output data": "Показать выходные данные транзакции",
            "Show all": "Показать все",
            "Show input": "Показать запись",
            "Show less": "Показать меньше",
            "Show more": "Показать больше",
            Size: "Размер",
            "Size (bytes)": "Размер (байтов)",
            "Skipped Blocks (previously synced)": "Пропущенные блоки (ранее синхронизированные)",
            "Start Date": "Дата начала",
            Status: "Статус",
            Summary: "Резюме",
            "Summary <small>confirmed</small>": "RРезюме <small>подтверждено</small>",
            "Sync Progress": "Прогресс синхронизации",
            "Sync Status": "Статус синхронизации",
            "Sync Type": "Тип синхронизации",
            "Synced Blocks": "Синхронизированных блоков",
            Testnet: "Тестовая сеть",
            "There are no transactions involving this address.": "Нет транзакций, связанных с этим адресом",
            "Time Offset": "Временной сдвиг",
            Timestamp: "Временная отметка",
            Today: "Сегодня",
            "Total Amount": "Общая сумма",
            "Total Received": "Всего получено",
            "Total Sent": "Всего отправленно",
            Transaction: "Транзакция",
            "Transaction Output Set Information": "Информация о выходных данных транзакций",
            "Transaction Outputs": "Выходные данные транзакции",
            Transactions: "Транзакции",
            Type: "Тип",
            Unconfirmed: "Не подтверждено",
            "Unconfirmed Transaction!": "Неподтвержденная транзакция!",
            "Unconfirmed Txs Balance": "Неподтвержденный баланс транзакции",
            "Value Out": "Значение",
            Version: "Версия",
            "Waiting for blocks...": "Ожидание блоков...",
            "Waiting for transactions...": "Ожидание транзакции...",
            "by date.": "по дате.",
            "first seen at": "Впервые обнаружен на",
            mined: "добыто",
            "mined on:": "добыто на:",
            "Waiting for blocks": "Ожидание блоков"
        }),
